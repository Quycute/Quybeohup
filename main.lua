...
function DeltaLib:Start(GuiConfig)
    ...
    GuiConfig.Name = GuiConfig.Name or "Quy beo hup"
	...
	GuiConfig["Name Info"] = GuiConfig["Name Info"] or "Dịt mẹ mày"
    GuiConfig["Name Dev"] = GuiConfig["Name Dev"] or tostring(game:GetService("Players").LocalPlayer.Name)
    GuiConfig["Info Description"] = GuiConfig["Info Description"] or "discord.gg
    ...
    function Tabs:MakeTab(NameTab)
        ...
        function Sections:Section(SectionConfig)
            ...
            SectionImage.Image = "rbxassetid://18981896724"
